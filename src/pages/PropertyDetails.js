...
const PropertyDetails = () => {
  ...
  //get the houses on the id

  const house = housesData.find((a) => a.id === +id);

  console.log(house);

  return (
    <section>
      <div className=" container max-w-7xl mx-auto min-h-[800px] mb-14  ">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between ">
          ...
          <div className=" mb-4 lg:mb-0 flex gap-x-2 text-sm ">
            ...
            <div className="bg-violet-500 text-white px-4 rounded-full">
              {house.country}
            </div>
          </div>
          <div>
        ...
        <div className=" flex flex-col items-start  gap-8 lg:flex-row  ">
          ...
          <div className="flex-1 bg-white w-full mb-8 border container border-gray-300 rounded-lg py-8">
            ...
            <form className="flex flex-col gap-y-4 ">
              ...
              rounded w-full p-4 h-36 text-sm  text-gray-400  "
                placeholder="Message"
                defaultValue={"Hello I am interested  in buying the property"}
              ></textarea>
              <div className=" flex gap-x-2 ">
                <button className=" bg-violet-700 hover:bg-violet-800 rounded p-4 text-sm text-white w-full transition  ">
                  Send me
                </button>
